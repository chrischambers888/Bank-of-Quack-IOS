-- Reimbursement Balance Migration
-- Implements proper reimbursement handling:
-- - Linked reimbursements: reduce expense value, impact balances inversely
-- - Unlinked reimbursements: count as income, no balance impact
--------------------------------------------------------------------------------

--------------------------------------------------------------------------------
-- UPDATE member_balances VIEW
-- Add reimbursement handling to balance calculations
--------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------
-- UPDATE create_transaction_with_splits FUNCTION
-- Add p_reimburses_transaction_id parameter
--------------------------------------------------------------------------------

DROP FUNCTION IF EXISTS public.create_transaction_with_splits(UUID, DATE, TEXT, NUMERIC, TEXT, UUID, UUID, UUID, TEXT, TEXT, UUID, BOOLEAN, TEXT, UUID, JSONB);
...
--------------------------------------------------------------------------------
-- UPDATE update_transaction_with_splits FUNCTION
-- Add p_reimburses_transaction_id parameter
--------------------------------------------------------------------------------

DROP FUNCTION IF EXISTS public.update_transaction_with_splits(UUID, DATE, TEXT, NUMERIC, TEXT, UUID, UUID, UUID, TEXT, TEXT, UUID, BOOLEAN, TEXT, JSONB);
